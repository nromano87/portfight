...
export const SKINS: Record<SkinId, SkinDef> = {
  ...
  catpajama: {
    ...
    name: "Cat Pajama",
    rarity: "uncommon",
    pfp: asset("/art/pfps/catpajama.png"),
    color: 0xd4a0b8,
    ...items("cotton-net"),
  },
  hotdog: {
  ...
  scarecrow: {
    ...
    name: "Scarecrow",
    rarity: "uncommon",
    pfp: asset("/art/pfps/scarecrow.png"),
    color: 0xc4a35a,
    ...items("wood"),
  },
  knight: {
  ...
  astronaut: {
    ...
    name: "Stargazer",
    rarity: "rare",
    pfp: asset("/art/pfps/astronaut.png"),
    color: 0xc8d0d8,
  ...
  skeleton: {
    ...
    name: "Skeleton",
    rarity: "rare",
    pfp: asset("/art/pfps/skeleton.png"),
    color: 0xe8e0d0,
    ...items("iron-ore", "flax"),
  },
  samurai: {
    ...
    name: "Samurai",
    rarity: "rare",
    pfp: asset("/art/pfps/samurai.png"),
    color: 0x8b1e1e,
  ...
  deepdiver: {
    ...
    name: "Deep Diver",
    rarity: "rare",
    pfp: asset("/art/pfps/deepdiver.png"),
    color: 0x1a4a6a,
  ...
  "ice-queen": {
    ...
    name: "Ice Queen",
    rarity: "rare",
    pfp: asset("/art/pfps/ice-queen.png"),
    color: 0xa8d4e8,
  ...
  squidly: {
    ...
    name: "Squidly",
    rarity: "epic",
    pfp: asset("/art/pfps/squidly.png"),
    color: 0x6a4a7c,
  ...
  "anubis-gold": {
    ...
    name: "Anubis Gold",
    rarity: "legendary",
    pfp: asset("/art/pfps/anubis-gold.png"),
    color: 0xe8c547,
  ...
  "skeleton-limited": {
    ...
    rarity: "legendary",
    pfp: asset("/art/pfps/skeleton-limited.png"),
    color: 0xb8862a,
  ...
  "ghost-limited": {
    ...
    name: "Ghost Limited",
    rarity: "legendary",
    pfp: asset("/art/pfps/ghost-limited.png"),
    color: 0x9aa8c8,
  ...
  "black-knight": {
    ...
    rarity: "legendary",
    pfp: asset("/art/pfps/black-knight.png"),
    color: 0x2a2a32,
